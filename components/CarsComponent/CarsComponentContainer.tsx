    ...
    return (
        <section className="px-4 mb-[120px] mt-[120px]">
            <div className="flex flex-col items-center mb-[72px]">
                <h2 className="text-4xl text-[#383F47] font-semibold text-center font-[rubik] mb-[20px]">{t("components.CarsComponentContainer.title")} {routeData.RouteTranslation[0].inRoute} - {routeData.RouteTranslation[0].toRoute}</h2>
            </div>
