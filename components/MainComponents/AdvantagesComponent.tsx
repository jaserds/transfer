        ...
        <div className="max-w-[710px] w-full">
            <ul className="flex justify-between gap-10">
                <li className="flex flex-col items-center flex-1">
                    ...
                    <p className={`text-center font-[rubik] text-base font-medium text-[#FFFFFF]`}>Русскоговорящий водитель</p>
                </li>
                <li className="flex flex-col items-center flex-1">
                    <Image src="/icons/main-advantages-icons/seat-icon.svg" width={60} height={60} alt="" />
                    <p className={`text-center font-[rubik] text-base font-medium text-[#FFFFFF]`}>Комфортная поездка</p>
                </li>
                <li className="flex flex-col items-center flex-1">
                    <Image src="/icons/main-advantages-icons/defence-icon.svg" width={60} height={60} alt="" />
                    <p className={`text-center font-[rubik] text-base font-medium text-[#FFFFFF]`}>Безопасность прежде всего</p>
                </li>
                <li className="flex flex-col items-center flex-1">
                    ...
                    <p className={`text-center font-[rubik] text-base font-medium text-[#FFFFFF]`}>Премиум автомобили</p>
                </li>
            </ul>
        </div>
    );
