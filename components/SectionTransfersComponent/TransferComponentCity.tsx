...
const TransferComponentCity = ({ dataSet, link }: ITransferComponentCityProps) => {
    ...
    return (
        <Link className="" href={link}>
            <div className="relative cursor-pointer min-w-[290px] 
                ...
                <p className="absolute top-[40px] right-[40px] text-white text-3xl font-semibold font-['Rubik'] leading-[15px] z-20">{dataSet.data.name}</p>
                <Image className="brightness-90 mb-[20px] rounded-[10px]" src={`${dataSet.data.imageUrl}`} width={330} height={351} alt="" />
